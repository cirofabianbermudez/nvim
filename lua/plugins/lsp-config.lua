  ...
  },
  {
    ...
    config = function()
      ...
      vim.diagnostic.config({
        ...
        -- Optional: You might want to adjust other diagnostic display options
        -- float = { border = "rounded" },  -- For floating window borders
        signs = false,                    -- Keep gutter signs
        underline = false,                -- Keep underline highlights
      ...
      -- vim.keymap.set('n', '<leader>lw', vim.diagnostic.open_float, { desc = "Open diagnostic float" })
